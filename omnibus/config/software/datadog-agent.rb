...
build do
  ...
  if linux?
    if debian?
      ...
      erb source: "upstart_debian.logs.conf.erb",
          dest: "#{install_dir}/scripts/datadog-agent-logs.conf",
          mode: 0755,
          vars: { install_dir: install_dir, etc_dir: etc_dir }
      ...
      erb source: "upstart_redhat.conf.erb",
          ...
          mode: 0755,
          vars: { install_dir: install_dir, etc_dir: etc_dir }
      erb source: "upstart_redhat.logs.conf.erb",
          dest: "#{install_dir}/scripts/datadog-agent-logs.conf",
          mode: 0755,
          vars: { install_dir: install_dir, etc_dir: etc_dir }
    ...
    erb source: "systemd.service.erb",
        ...
        mode: 0755,
        vars: { install_dir: install_dir, etc_dir: etc_dir }
    erb source: "systemd.logs.service.erb",
        dest: "#{install_dir}/scripts/datadog-agent-logs.service",
        mode: 0755,
        vars: { install_dir: install_dir, etc_dir: etc_dir }
